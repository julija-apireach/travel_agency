    ...
    @section('hero')
        <div class="flex flex-col gap-4 md:gap-6 px-6 md:px-8 lg:px-12 xl:px-64 md:pt-8 md:pb-20 xl:py-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                <!--Atsauksmju box-1 - TEST-->
                <div
                    class="flex flex-col gap-2 p-4 border border-red-100 md:border-yellow-200 shadow-sm md:shadow-xl shadow-yellow-200">
                    <!--Foto, vards uzvards-->
                ...
                @foreach ($reviews as $review)
                    <!--Atsauksmju box-1-->
                    <div
                        class="flex flex-col justify-between p-4 border border-red-100 md:border-yellow-200 shadow-sm md:shadow-xl shadow-yellow-200">
                        <!--Foto, vards uzvards-->
                        <div class="flex gap-6">
                            ...
                            <div>
                                <div class="flex gap-2 pt-8">
                                    <h3 class="text-base font-semibold md:text-2xl md:font-bold">{{ $review->first_name }}
                                    </h3>
                                    <h3 class="text-base font-semibold md:text-2xl md:font-bold">{{ $review->last_name }}
                                    </h3>
                                </div>
