    ...
    @section('hero')
        <div class="md:px-8 lg:px-12 xl:px-64 md:py-8 lg:py-12">
            ...
            <div class="hidden md:block">
                <h2 class="text-xl font-normal mb-12">Ekskursiju ceļojumi</h2>

                @for ($i = 0; $i < 6; $i++)
                    <div class="mb-4">
                        <div class="border-2 border-yellow-200 p-4 relative md:grid grid-cols-3 gap-4">
                            <div class="col-span-1">
                                <img src="{{ asset('images/trips/germany.svg') }}" class="h-full w-full">
                            </div>
                            <div class="col-span-2 flex flex-col justify-between">
                                <div class="flex flex-col gap-4">
                                    <h2 class="text-3xl font-bold">Iepirkšanās tūre Vācijā</h2>
                            ...
                            <div class="flex md:flex-col lg:flex-row gap-2 lg:gap-4 items-center absolute top-0 right-2">
                                <img src="{{ asset('images/trips/bus.svg') }}">
                                <p class="font-bold text-3xl text-red-500">207€</p>
                            </div>
                        </div>
                    </div>
                @endfor
            ...
            <div class="block md:hidden">
                ...
                <div class="flex gap-2 items-center px-6">
                    <h2 class="text-base font-medium py-4">Ekskursiju ceļojumi</h2>
                    <img src="{{ asset('images/trips/bus.svg') }}" class="w-10">
                </div>
                        ...
                        <div class="px-6 flex flex-col justify-center items-center gap-1 mb-4">
                            ...
                            <div class="rounded-tr-lg">
                                ...
                                <div class="flex justify-between">
                                    <h2 class="text-base font-bold">Iepirkšanās tūre Vācijā</h2>
                            ...
                            <div class="flex flex-col gap-1">
                                <h3 class="px-1 font-bold text-base">27.02 - 2.03.2024 <span class="font-normal text-base">- 5
                                        dienas</span></h3>
                                <p class="px-1 text-sm">Lorem ipsum dolor sit amet, consectetur
