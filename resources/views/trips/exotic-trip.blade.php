<x-guest-layout>
    @section('hero')
        ...
        <div class="hidden border md:flex flex-col md:gap-8 md:px-8 lg:px-12 xl:px-64 md:py-8 lg:py-12">
            <h3 class="text-base md:text-2xl lg:text-4xl font-medium md:font-normal">Eksotiskie ceļojumi</h3>
            <div class="md:grid grid-cols-3 gap-4">
                ...
                <div class="col-span-2">
                    <div class="flex flex-col gap-5">
                        <!--Box-->
                        @for($i=0; $i<6; $i++)
                        <div class="grid-cols-9 border border-yellow-200 shadow-lg shadow-yellow-100 py-4 px-3 grid gap-3">
                            <!--Foto-->
                            ...
                            <div class="col-span-5 flex flex-col justify-between gap-4">
                                <div>
                                    ...
                                    <h4 class="text-base font-normal"><span class="uppercase">SHARIM IM AMAREIN
                                            4</span><span>&starf; </span>no <span class="text-red-500 font-bold">399€</span>
                                    </h4>
                                </div>
                                <div>
                        ...
                        <div class="flex justify-end pr-3">
                            <a href="#" class="bg-[#FFCF00] rounded-full px-16 py-2 text-lg font-medium">Vairāk</a>
                        </div>
                        @endfor
                    </div>
                </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <div class="relative px-2 py-2 rounded-tr-lg">
                                <div class="relative z-0 pt-3 pl-3"><img src="{{ asset('images/destinations/egypt.svg') }}" class="rounded-tr-xl rounded-tl-xl"></div>
                                <div class="absolute top-0 left-0 z-10"><img src="{{ asset('images/destinations/discount.svg') }}"></div> 
                            </div>
                            <!--Description-->
                        ...
                        <div class="flex justify-center">
                            <a href="#" class="bg-[#FFCF00] rounded-full px-16 py-3 text-lg font-medium">Vairāk</a>
                        </div>
                    </div>
                </div>
                </div>
